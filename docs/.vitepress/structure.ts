    ...
    items: [
      ...
      { text: 'Liste inlantuite', link: '/cpp/algoritmi/clasa-a-10a/liste-inlantuite' },
      {
        ...
        items: [
          ...
          { text: 'Algoritmul lui Lee', link: '/cpp/algoritmi/clasa-a-10a/lee' },
          { text: 'Algoritmi de fill', link: '/cpp/algoritmi/clasa-a-10a/algoritmi-de-fill' },
        ],
      },
    ],
  },
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Repeta in executa cat timp', link: '/cpp/pseudocod/conversii/repeta-in-executa-cat-timp' },
        ],
      },
    ],
  },
